          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-2 text-sun flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                <div className="text-mist/80 leading-relaxed">
                  <div className="font-semibold text-mist">TAYI SĀDHANA YOGA</div>
                  <div>Yoga Master Hemanth</div>
                  <div>No. 153, 6th Cross, Gokulam,</div>
                  <div>Mysuru, Karnataka, India</div>
                  <div className="text-mist/70 text-xs mt-0.5">2nd Floor, Doctor Corner</div>
                </div>
              </li>
              <li className="flex items-center">
                <svg className="w-5 h-5 mr-2 text-sun flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://wa.me/918762120909" target="_blank" rel="noopener noreferrer" className="text-mist/80 hover:text-sun transition-colors">
                  WhatsApp: +91 87621 20909
                </a>
              </li>
              <li className="flex items-center">
                ...
                <a href="mailto:hemanth@tayi.yoga" className="text-mist/80 hover:text-sun transition-colors">
                  hemanth@tayi.yoga
                </a>
              </li>
              <li className="flex items-center">
                ...
                <a href="https://tayi.yoga" target="_blank" rel="noopener noreferrer" className="text-mist/80 hover:text-sun transition-colors">
                  Website: tayi.yoga
                </a>
              </li>
            </ul>
