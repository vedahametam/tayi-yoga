      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <ImagePlaceholder width={600} height={800} text="Welcome Image - Yoga Practice" src="/images/general/welcome.png" alt="Welcome to Tayi Sadhana Yoga" className="rounded-lg shadow-2xl" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Link to="/education/yoga-ttc" className="group bg-gradient-to-br from-earth to-clay text-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all hover:scale-105">
              <div className="p-6">
                ...
                <h3 className="text-2xl font-serif font-bold mb-3">Yoga TTC</h3>
                <p className="text-mist/90 mb-4">
                  200/300/500 hour Teacher Training Certification in Tayi Sadhana Yoga
                </p>
            ...
            <Link to="/education/nature-cure-ttc" className="group bg-gradient-to-br from-leaf to-earth text-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all hover:scale-105">
              <div className="p-6">
                ...
                <h3 className="text-2xl font-serif font-bold mb-3">Nature Cure TTC</h3>
                <p className="text-mist/90 mb-4">
                  Comprehensive training in natural healing and wellness therapies
                </p>
                <span className="inline-flex items-center text-sun font-semibold group-hover:translate-x-2 transition-transform">
                  Learn More
                  <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Program 3 */}
            <Link to="/education/master-ttc" className="group bg-gradient-to-br from-ink to-earth text-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all hover:scale-105">
              <div className="p-6">
                <div className="mb-4">
                  <svg className="w-12 h-12 text-sun" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 className="text-2xl font-serif font-bold mb-3">Master TTC</h3>
                <p className="text-mist/90 mb-4">
                  Advanced mastery program for experienced practitioners and teachers
                </p>
                <span className="inline-flex items-center text-sun font-semibold group-hover:translate-x-2 transition-transform">
                  Learn More
                  <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Program 4 */}
            <Link to="/education/philosophy-ttc" className="group bg-gradient-to-br from-clay to-sun text-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all hover:scale-105">
              <div className="p-6">
                <div className="mb-4">
                ...
                <h3 className="text-2xl font-serif font-bold mb-3">Philosophy TTC</h3>
                <p className="text-mist/90 mb-4">
                  Deep dive into yogic philosophy, scriptures, and spiritual wisdom
                </p>
